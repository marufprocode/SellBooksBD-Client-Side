        ...
        <>
          ...
          <div className="modal">
            <div className="modal-box">
              <h3 className="font-bold text-lg">Sorry! you have to login from a buyer account to purchase product</h3>
              <p className="py-4">Please Sign In from a buyer account to purchase product.</p>
              <div className="modal-action">
                <label htmlFor="bookingModal" className="btn">Ok</label>
              </div>
            </div>
          </div>
        </>
